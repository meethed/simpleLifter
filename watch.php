...
<div id="alignme">
<!-- iFrame for youtube -->
<div id="containertubeframe">
<?php if (strpos($r["streamURL"],"embed") >10) {?>
  <iframe id="tubeframe" src="<?php echo $r["streamURL"]; ?>"></iframe>
 <?php } else { ?>
  <a id="tubeframe" href="<?php echo $r["streamURL"];?>">Live Stream Link</a>
<?php } ?>
...
let id,idx;
  ...
  if (id=="all") {
    liveframe.src="./results.php?iframe=1&c="+compLetters+"&ia=1";
