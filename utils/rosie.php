...
$allowedfileExtensions = array('html', 'htm', 'php', 'js', 'css', 'jpg', 'gif', 'png', 'zip', 'txt', 'xls', 'doc','php','xlsm');
if (in_array($fileExtension, $allowedfileExtensions)) {
 ...
 {
   $message ='File is successfully uploaded.'.'<a href="/rosie/'.$newFileName.'">Click Here</a"';
 }
 else
 {
